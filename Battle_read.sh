...
./ocrutil/OcrUtil KeepPixels /tmp/Win_2.png /tmp/Win_C1.png ./ocrutil/whitelist.txt
convert -resize 200% '/tmp/Win_C1.png' '/tmp/Win_C.png'
...
./ocrutil/OcrUtil KeepPixels /tmp/Loose_2.png /tmp/Loose_C1.png ./ocrutil/whitelist.txt
convert -resize 200% '/tmp/Loose_C1.png' '/tmp/Loose_C.png'
