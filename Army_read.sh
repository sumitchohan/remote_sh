...
tesseract /tmp/Trained_C1.png /tmp/Trained_C --tessdata-dir ~/Desktop/gh/remote_sh/tessdata -l coc1
cat "/tmp/Trained_C.txt" | sed 's/[^0-9]*//g' > /tmp/Trained.txt
adb push /tmp/Trained.txt /sdcard/coc/ocred_Trained.txt
...
convert -resize 200% /tmp/Total_C.png /tmp/Total_C1.png
tesseract /tmp/Total_C1.png /tmp/Total_C --tessdata-dir ~/Desktop/gh/remote_sh/tessdata -l coc1
cat "/tmp/Total_C.txt" | sed 's/[^0-9]*//g' > /tmp/Total.txt
adb push /tmp/Total.txt /sdcard/coc/ocred_Total.txt
...
convert -resize 200% /tmp/Full_C.png /tmp/Full_C1.png
tesseract /tmp/Full_C1.png /tmp/Full_C --tessdata-dir ~/Desktop/gh/remote_sh/tessdata -l coc1
cat "/tmp/Full_C.txt" | sed 's/[^0-9]*//g' > /tmp/Full.txt
adb push /tmp/Full.txt /sdcard/coc/ocred_Full.txt
...
convert -resize 200% /tmp/Troop1Level_C.png /tmp/Troop1Level_C1.png
tesseract /tmp/Troop1Level_C1.png /tmp/Troop1Level_C --tessdata-dir ~/Desktop/gh/remote_sh/tessdata -l coc1
cat "/tmp/Troop1Level_C.txt" | sed 's/[^0-9]*//g' > /tmp/Troop1Level.txt
adb push /tmp/Troop1Level.txt /sdcard/coc/ocred_Troop1Level.txt
...
convert -resize 200% /tmp/Troop2Level_C.png /tmp/Troop2Level_C1.png
tesseract /tmp/Troop2Level_C1.png /tmp/Troop2Level_C --tessdata-dir ~/Desktop/gh/remote_sh/tessdata -l coc1
cat "/tmp/Troop2Level_C.txt" | sed 's/[^0-9]*//g' > /tmp/Troop2Level.txt
adb push /tmp/Troop2Level.txt /sdcard/coc/ocred_Troop2Level.txt
...
convert -resize 200% /tmp/Troop3Level_C.png /tmp/Troop3Level_C1.png
tesseract /tmp/Troop3Level_C1.png /tmp/Troop3Level_C --tessdata-dir ~/Desktop/gh/remote_sh/tessdata -l coc1
cat "/tmp/Troop3Level_C.txt" | sed 's/[^0-9]*//g' > /tmp/Troop3Level.txt
adb push /tmp/Troop3Level.txt /sdcard/coc/ocred_Troop3Level.txt
...
convert -resize 200% /tmp/Troop1Count_C.png /tmp/Troop1Count_C1.png
tesseract /tmp/Troop1Count_C1.png /tmp/Troop1Count_C --tessdata-dir ~/Desktop/gh/remote_sh/tessdata -l coc1
cat "/tmp/Troop1Count_C.txt" | sed 's/[^0-9]*//g' > /tmp/Troop1Count.txt
adb push /tmp/Troop1Count.txt /sdcard/coc/ocred_Troop1Count.txt
...
convert -resize 200% /tmp/Troop2Count_C.png /tmp/Troop2Count_C1.png
tesseract /tmp/Troop2Count_C1.png /tmp/Troop2Count_C --tessdata-dir ~/Desktop/gh/remote_sh/tessdata -l coc1
cat "/tmp/Troop2Count_C.txt" | sed 's/[^0-9]*//g' > /tmp/Troop2Count.txt
adb push /tmp/Troop2Count.txt /sdcard/coc/ocred_Troop2Count.txt
...
convert -resize 200% /tmp/Troop3Count_C.png /tmp/Troop3Count_C1.png
tesseract /tmp/Troop3Count_C1.png /tmp/Troop3Count_C --tessdata-dir ~/Desktop/gh/remote_sh/tessdata -l coc1
cat "/tmp/Troop3Count_C.txt" | sed 's/[^0-9]*//g' > /tmp/Troop3Count.txt
adb push /tmp/Troop3Count.txt /sdcard/coc/ocred_Troop3Count.txt
...
convert -resize 200% /tmp/Spells1Left_C.png /tmp/Spells1Left_C1.png
tesseract /tmp/Spells1Left_C1.png /tmp/Spells1Left_C --tessdata-dir ~/Desktop/gh/remote_sh/tessdata -l coc1
cat "/tmp/Spells1Left_C.txt" | sed 's/[^0-9]*//g' > /tmp/Spells1Left.txt
adb push /tmp/Spells1Left.txt /sdcard/coc/ocred_Spells1Left.txt
...
convert -resize 200% /tmp/Spells1Right_C.png /tmp/Spells1Right_C1.png
tesseract /tmp/Spells1Right_C1.png /tmp/Spells1Right_C --tessdata-dir ~/Desktop/gh/remote_sh/tessdata -l coc1
cat "/tmp/Spells1Right_C.txt" | sed 's/[^0-9]*//g' > /tmp/Spells1Right.txt
adb push /tmp/Spells1Right.txt /sdcard/coc/ocred_Spells1Right.txt
...
convert -resize 200% /tmp/Spells1Full_C.png /tmp/Spells1Full_C1.png
tesseract /tmp/Spells1Full_C1.png /tmp/Spells1Full_C --tessdata-dir ~/Desktop/gh/remote_sh/tessdata -l coc1
cat "/tmp/Spells1Full_C.txt" | sed 's/[^0-9]*//g' > /tmp/Spells1Full.txt
adb push /tmp/Spells1Full.txt /sdcard/coc/ocred_Spells1Full.txt
convert '/tmp/scr.png[56x21+286+434]' /tmp/cc.png
./ocrutil/OcrUtil KeepPixels /tmp/cc.png /tmp/cc_C.png ./ocrutil/whitelist.txt
convert -resize 200% /tmp/cc_C.png /tmp/cc_C1.png
tesseract /tmp/cc_C1.png /tmp/cc_C --tessdata-dir ~/Desktop/gh/remote_sh/tessdata -l coc1
cat "/tmp/cc_C.txt" | sed 's/[^0-9]*//g' > /tmp/cc.txt
adb push /tmp/cc.txt /sdcard/coc/ocred_cc.txt
...
convert -resize 200% /tmp/ccSpell_C.png /tmp/ccSpell_C1.png
