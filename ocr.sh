...
do
	parts=($(echo "$line" | tr ',' '\n'))
	echo "convert '/tmp/scr.png[${parts[3]}x${parts[4]}+${parts[1]}+${parts[2]}]' /tmp/${parts[0]}_\$dt_1.png" >>$1_read.sh
	echo "convert /tmp/${parts[0]}_\$dt_1.png -fuzz 300 -fill white -opaque "#FFE8FD" /tmp/${parts[0]}_\$dt.png">>$1_read.sh
