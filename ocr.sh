...
do
	...
	echo "#./ocrutil/OcrUtil KeepPixels /tmp/${parts[0]}_2.png /tmp/${parts[0]}_C.png ./ocrutil/whitelist.txt" >>$1_read.sh
	echo "convert -resize 200% /tmp/${parts[0]}_2.png /tmp/${parts[0]}_C1.png" >>$1_read.sh 
