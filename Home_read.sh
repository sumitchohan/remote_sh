...
convert -resize 200% /tmp/Trophy_2.png /tmp/Trophy_C1.png
...
convert -resize 200% /tmp/Gold_2.png /tmp/Gold_C1.png
...
convert -resize 200% /tmp/Elixir_2.png /tmp/Elixir_C1.png
...
convert -resize 200% /tmp/DE_2.png /tmp/DE_C1.png
...
convert -resize 200% /tmp/Gems_2.png /tmp/Gems_C1.png
...
convert -resize 200% /tmp/Builders_2.png /tmp/Builders_C1.png
